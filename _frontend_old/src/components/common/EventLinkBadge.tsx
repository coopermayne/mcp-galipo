...
export function EventLinkBadge({ eventDescription, eventDate }: EventLinkBadgeProps) {
  ...
  return (
    <div className="relative group flex-shrink-0">
      ...
      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-bg-surface text-white text-xs rounded shadow-lg whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
