    ...
    <>
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex items-center gap-2 w-full px-3 py-2 text-left text-sm text-text-secondary hover:bg-bg-hover rounded-lg transition-colors"
        >
        ...
        {isOpen && (
          <div className="absolute bottom-full left-0 right-0 mb-1 bg-bg-surface rounded-lg shadow-lg border border-border py-1 z-50">
            ...
            <button
              ...
              className="flex items-center gap-2 w-full px-3 py-2 text-sm text-text-secondary hover:bg-bg-hover"
            >
