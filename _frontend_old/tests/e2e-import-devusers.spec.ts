...
test.describe('Dev Users — seeded user verification', () => {
  test('seeded dev users exist and have correct properties', async ({ page }) => {
    ...
    const cooper = users.find((u: any) => u.email === 'cmayne@example.com');
    ...
    const darci = users.find((u: any) => u.email === 'dgilbert@example.com');
    ...
    const dave = users.find((u: any) => u.email === 'davegalipo@example.com');
  ...
  test('attorney-paralegal relationships are set correctly', async ({ page }) => {
    ...
    const hang = users.find((u: any) => u.email === 'hlee@example.com');
    const santiago = users.find((u: any) => u.email === 'slaurel@example.com');
...
test.describe('Case creation and attorney assignment', () => {
  ...
  test('create case, assign attorney, verify paralegal auto-assigned', async ({ page }) => {
    ...
    const attorney = users.find((u: any) => u.email === 'cmayne@example.com');
