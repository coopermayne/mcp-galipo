...
interface TaskDropZonesProps {
  isVisible: boolean;
}

/**
 * Drop zones that appear on the right side when dragging tasks.
 * Must be rendered inside a DndContext to work.
 */
export function TaskDropZones({ isVisible }: TaskDropZonesProps) {
  if (!isVisible) {
    return null;
  }
