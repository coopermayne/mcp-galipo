/**
 * TasksLayoutSelector - Dropdown to select multi-panel layout preset
 *
...
interface TasksLayoutSelectorProps {
  value: LayoutPreset;
  onChange: (layout: LayoutPreset) => void;
}

export function TasksLayoutSelector({ value, onChange }: TasksLayoutSelectorProps) {
